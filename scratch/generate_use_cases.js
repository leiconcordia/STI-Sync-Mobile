...
const content = `# STI Sync - Comprehensive Use Case Diagrams & Specifications
...
const rootDocsPath = path.resolve('C:/VSCODE PROJECTS/STI SYNC WEB AND MOBILE/docs/use-case-diagrams.md');
fs.writeFileSync(rootDocsPath, content, 'utf8');

const mobileDocsPath = path.resolve('C:/VSCODE PROJECTS/STI SYNC WEB AND MOBILE/STI_Sync/docs/use-case-diagrams.md');
fs.writeFileSync(mobileDocsPath, content, 'utf8');

const webDocsPath = path.resolve('C:/VSCODE PROJECTS/STI SYNC WEB AND MOBILE/STI Sync Web/docs/use-case-diagrams.md');
fs.writeFileSync(webDocsPath, content, 'utf8');

console.log('Updated all use-case-diagrams.md files.');
